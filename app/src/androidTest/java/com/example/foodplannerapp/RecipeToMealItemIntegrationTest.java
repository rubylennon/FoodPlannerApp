...
public class RecipeToMealItemIntegrationTest {
    String email,
            password,
            recipeName,
            recipeCookingTime,
    ...
    @Test
    public void test1_AddRecipeToPlanAndAssertMealDetails(){
        ...
        ViewInteraction materialButton13 = onView(
                allOf(withId(R.id.idBtnAddToMealPlan), withText("Add Recipe to Meal Plan"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.RelativeLayout")),
                                        0),
        ...
        ViewInteraction materialButton15 = onView(
                allOf(withId(R.id.idBtnViewDetails), withText("Recipe Details & Shopping List"),
                        childAtPosition(
                                allOf(withId(R.id.idBtnGroup1),
                                        childAtPosition(
